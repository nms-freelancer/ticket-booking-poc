...
@Component({
  selector: 'app-panorama-view',
  templateUrl: './panorama-view.component.html',
  styleUrls: ['./panorama-view.component.scss']
})
export class PanoramaViewComponent implements AfterViewInit {
  ...
  images = ["/assets/textures/image1.jpg",
  ...
  @Input()
  public texture: string = '/assets/textures/image4.jpg';
  ...
  private startRendering() {
    ...
    let component: PanoramaViewComponent = this;
